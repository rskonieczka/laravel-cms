...
@section('content')
    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            <h1>
                Edycja strony <i>{{  $site->name }}</i>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">Edycja strony</li>
            </ol>
        </section>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box box-success">
                        ...
                        {{ Form::open(array('route' => array('admin.site.update', $site->id), 'method' => 'put')) }}
                        {{ Form::token() }}
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group @if ($errors->has('name')) has-error @endif">
                                ...
                                {{ Form::text('name', $site->name, array('class' => 'form-control', 'id' => 'name', 'placeholder' => 'Nazwa') ) }}
                                @if ($errors->has('name')) <p class="help-block">{{ $errors->first('name') }}</p> @endif
                            </div>
                            <div class="form-group @if ($errors->has('domain')) has-error @endif">
                                {{ Form::label('domain', 'Domena') }}
                                {{ Form::text('domain', $site->domain, array('class' => 'form-control', 'id' => 'domain', 'placeholder' => 'Domena') ) }}
                            ...
                            {{ Form::label('theme', 'Szablon') }}
                                {{ Form::text('theme', $site->theme, array('class' => 'form-control', 'id' => 'theme', 'placeholder' => 'Szablon') ) }}
