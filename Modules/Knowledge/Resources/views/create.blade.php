    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Dodaj nowy post</li>
            </ol>
        </section>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box box-success">
                        ...
                        {{ Form::open(array('route' => 'admin.knowledge.store', 'files'=> true)) }}
                        {{ Form::token() }}
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group @if ($errors->has('causes')) has-error @endif">
                                ...
                                {{ Form::textarea('causes', Input::old('causes'), array('class' => 'form-control', 'id' => 'wysihtml6', 'placeholder' => 'Przyczyny') ) }}
                            ...
                            <div class="form-group @if ($errors->has('prevention')) has-error @endif">
                                ...
                                {{ Form::textarea('prevention', Input::old('prevention'), array('class' => 'form-control', 'id' => 'wysihtml7', 'placeholder' => 'Zapobieganie') ) }}
                            ...
                            <div class="form-group @if ($errors->has('repair')) has-error @endif">
                                ...
                                {{ Form::textarea('repair', Input::old('repair'), array('class' => 'form-control', 'placeholder' => 'Naprawa') ) }}
                            ...
                            <div class="form-group @if ($errors->has('movie')) has-error @endif">
                                ...
                                {{ Form::textarea('movie', Input::old('movie'), array('class' => 'form-control', 'id' => 'wysihtml8', 'placeholder' => 'Film') ) }}
