                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group @if ($errors->has('first_name')) has-error @endif">
                            ...
                            {{ Form::text('first_name', Input::old('first_name'), array('class' => 'form-control', 'id' => 'first_name', 'placeholder' => 'Imię') ) }}
                            @if ($errors->has('first_name')) <p class="help-block">{{ $errors->first('first_name') }}</p> @endif
                        </div>
                        <div class="form-group @if ($errors->has('last_name')) has-error @endif">
                            {{ Form::label('last_name', 'Nazwisko') }}
                            {{ Form::text('last_name', Input::old('last_name'), array('class' => 'form-control', 'id' => 'last_name', 'placeholder' => 'Nazwisko') ) }}
                            @if ($errors->has('last_name')) <p class="help-block">{{ $errors->first('last_name') }}</p> @endif
                        </div>
                        <div class="form-group @if ($errors->has('email')) has-error @endif">
                            {{ Form::label('email', 'E-mail (login)') }}
                            {{ Form::text('email', Input::old('email'), array('class' => 'form-control', 'id' => 'email', 'placeholder' => 'E-mail (login)') ) }}
                            @if ($errors->has('email')) <p class="help-block">{{ $errors->first('email') }}</p> @endif
                        </div>
                        <div class="form-group @if ($errors->has('password')) has-error @endif">
                            {{ Form::label('password', 'Hasło') }}
                            {{ Form::password('password', array('class' => 'form-control', 'id' => 'password', 'placeholder' => 'Hasło') ) }}
                        ...
                        <div class="form-group @if ($errors->has('group_id')) has-error @endif">
                            ...
                            {{ Form::select('group_id', $groups, Input::old('group_id'), array('class' => 'form-control', 'id' => 'site_id', 'placeholder' => 'Grupa')) }}
                        ...
                        <div class="form-group @if ($errors->has('activated')) has-error @endif">
                            ...
                            <br />
                            {{ Form::checkbox('activated', 1, Input::old('activated'), array('class' => 'form-control', 'id' => 'activated', 'placeholder' => 'Aktywuj konto') ) }}
