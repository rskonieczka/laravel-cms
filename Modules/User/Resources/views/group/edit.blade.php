                    ...
                    @if ($errors->has())
                        @foreach ($errors->all() as $error)
                            ...
                            <div class="box box-success">
                                ...
                                {{ Form::open(array('route' => array('admin.group.update', $group->id), 'method' => 'put')) }}
                                {{ Form::token() }}
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group @if ($errors->has('name')) has-error @endif">
                                        ...
                                        {{ Form::text('name', $group->name, array('class' => 'form-control', 'id' => 'name', 'placeholder' => 'Nazwa grupy') ) }}
                                        @if ($errors->has('name')) <p class="help-block">{{ $errors->first('name') }}</p> @endif
                                    </div>
                                    <div class="form-group @if ($errors->has('permissions')) has-error @endif">
                                        {{ Form::label('permissions', 'Prawa') }}
                                        {{ Form::textarea('permissions', json_encode($group->permissions), array('class' => 'form-control', 'id' => 'name', 'placeholder' => 'Prawa') ) }}
