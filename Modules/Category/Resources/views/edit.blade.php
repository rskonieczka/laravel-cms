                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group @if ($errors->has('parent')) has-error @endif">
                            ...
                            {{ Form::select('parent', $select, $category->parent, array('class' => 'form-control', 'id' => 'select2', 'placeholder' => 'Rodzic')) }}
                        ...
                        <div class="form-group @if ($errors->has('device')) has-error @endif">
                            ...
                            {{ Form::select('device', ['all' => 'wszystkie', 'mobile' => 'mobilne', 'desktop' => 'desktop'], $category->device, array('class' => 'form-control', 'id' => 'select2')) }}
