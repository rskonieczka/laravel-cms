<?php
/**
 * Joe Green says this file has been modified.
 *
 * The class_exists() and interface_exists() calls at the beginning of Zend_Loader::loadClass() were bypassing the autoloader.
 * This has been changed to use the registered autoloader (i.e. to use the composer autoloader).
 * This should speed up calls to Zend_Loader::loadClass() considerably.
 */
