...
(function ($) {
    ...
    $('[data-toggle="ajaxModal"]').on('click',
        function(e) {
            ...
            var $this = $(this)
                ...
                , $modal = $('<div class="modal fade popup" id="ajaxModal"></div>');
            $('body').append($modal);
	...
	$('#countdown').countdown({until: new Date('2015/05/27'), compact: true,
		description: ''});
...
$(document).ready(function() {
	//Cookies
	var issetCookies = $.cookie('cookies-alert'),
		$cookiesContainer = $('.cookies-alert');
	...
	$('.cookies-alert .close').on('click', function() {
		$.cookie('cookies-alert', '1', { expires: 2 });
