	...
	<div class="contact-menu" id="{{ trans('routes.home_contact_contactmenu') }}">
		<div class="container-fluid">
			<ul class="list-unstyled" role="tablist">
				...
				<li><a href="#contact-box-2" role="tab" data-toggle="tab" data-subtabs="#subtabs-1">{{ trans('interface.home_contact_rh') }}</a></li>
				<li><a href="#contact-box-3" role="tab" data-toggle="tab" data-subtabs="#subtabs-2">{{ trans('interface.home_contact_marketing') }}</a></li>
				<li><a href="#contact-box-4" role="tab" data-toggle="tab">{{ trans('interface.home_contact_workshops') }}</a></li>
                <li><a href="#contact-box-5" role="tab" data-toggle="tab">{{ trans('interface.home_contact_sale')}}</a></li>
				{{--<li><a class="has-more" href="#sale-1" role="tab" data-toggle="tab" data-subtabs="subtabs-1">{{
				trans('interface.home_contact_other')}}</a></li>--}}
			</ul>
		</div>
	</div>
	<div class="tab-content">
		{{--<div id="subtabs-1" class="contact-menu contact-menu-submenu">--}}
			{{--<div class="container-fluid">--}}
				{{--<ul class="list-unstyled" role="tablist">--}}
					{{--<li class="active"><a href="#sale-1" role="tab" data-toggle="tab">Promocje</a></li>--}}
					{{--<li><a href="#sale-2" role="tab" data-toggle="tab">Laboratorium badawczo-rozwojowe</a></li>--}}
					{{--<li><a href="#sale-3" role="tab" data-toggle="tab">Laboratorium technologiczne</a></li>--}}
					{{--<li><a href="#sale-4" role="tab" data-toggle="tab">Produkcja</a></li>--}}
					{{--<li><a href="#sale-5" role="tab" data-toggle="tab">Kadry</a></li>--}}
					{{--<li><a href="#sale-6" role="tab" data-toggle="tab">Dział techniczny</a></li>--}}
					{{--<li><a href="#sale-7" role="tab" data-toggle="tab">Dział finansowy</a></li>--}}
					{{--<li><a href="#sale-8" role="tab" data-toggle="tab">Audyt wewnętrzny</a></li>--}}
					{{--<li><a href="#sale-9" role="tab" data-toggle="tab">Dyrektor ds. systemów zarządzania</a></li>--}}
					{{--<li><a href="#sale-10" role="tab" data-toggle="tab">Zarząd</a></li>--}}
				{{--</ul>--}}
			{{--</div>--}}
		{{--</div>--}}
		...
		<div id="contact-box-2" role="tabpanel" class="tab-pane">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-6">
						<h3>{{ renderText($category->texts, 'contactPr', 'title') }}</h3>
						<br />
						<div>{{ renderText($category->texts, 'contactPr', 'content') }}</div>
					</div>
					<div class="col-md-6">
		...
		<div id="contact-box-4" role="tabpanel" class="tab-pane">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h3>{{ renderText($category->texts, 'contactWorkshops', 'title') }}</h3>
						<br />
					</div>
					<div class="col-md-12">
						<div>{{ renderText($category->texts, 'contactWorkshops', 'content') }}</div>
					</div>
				</div>
			</div>
		</div>
		<div id="contact-box-5" role="tabpanel" class="tab-pane">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h3>{{ renderText($category->texts, 'contactSale', 'title') }}</h3>
						<br />
					</div>
					<div class="col-md-12">
						<div>{{ renderText($category->texts, 'contactSale', 'content') }}</div>
					</div>
				</div>
			</div>
		</div>
		{{--<div id="sale-1" role="tabpanel" class="tab-pane tab-subpane">--}}
            {{--<div class="container-fluid">--}}
                {{--<div class="row">--}}
                    {{--<div class="col-md-12">--}}
                        {{--<h3>{{ renderText($category->texts, 'contactPromotion', 'title') }}</h3>--}}
                        {{--<br />--}}
                    {{--</div>--}}
                    {{--<div class="col-md-12">--}}
            ...
            {{--</div>--}}
		{{--</div>--}}
        {{--<div id="sale-2" role="tabpanel" class="tab-pane tab-subpane">--}}
            {{--<div class="container-fluid">--}}
                {{--<div class="row">--}}
                    {{--<div class="col-md-12">--}}
                        {{--<h3>{{ renderText($category->texts, 'contactLab', 'title') }}</h3>--}}
                        {{--<br />--}}
                    {{--</div>--}}
                    {{--<div class="col-md-12">--}}
            ...
            {{--</div>--}}
        {{--</div>--}}
        {{--<div id="sale-3" role="tabpanel" class="tab-pane tab-subpane">--}}
            {{--<div class="container-fluid">--}}
                {{--<div class="row">--}}
                    {{--<div class="col-md-12">--}}
                        {{--<h3>{{ renderText($category->texts, 'contactLabtech', 'title') }}</h3>--}}
                        {{--<br />--}}
                    {{--</div>--}}
                    {{--<div class="col-md-12">--}}
            ...
            {{--</div>--}}
        {{--</div>--}}
        {{--<div id="sale-4" role="tabpanel" class="tab-pane tab-subpane">--}}
            {{--<div class="container-fluid">--}}
                {{--<div class="row">--}}
                    {{--<div class="col-md-12">--}}
                        {{--<h3>{{ renderText($category->texts, 'contactProduction', 'title') }}</h3>--}}
                        {{--<br />--}}
                    {{--</div>--}}
                    {{--<div class="col-md-12">--}}
            ...
            {{--</div>--}}
        {{--</div>--}}
        {{--<div id="sale-5" role="tabpanel" class="tab-pane tab-subpane">--}}
            {{--<div class="container-fluid">--}}
                {{--<div class="row">--}}
                    {{--<div class="col-md-12">--}}
                        {{--<h3>{{ renderText($category->texts, 'contactPersonnel', 'title') }}</h3>--}}
                        {{--<br />--}}
                    {{--</div>--}}
                    {{--<div class="col-md-12">--}}
            ...
            {{--</div>--}}
        {{--</div>--}}
        {{--<div id="sale-6" role="tabpanel" class="tab-pane tab-subpane">--}}
            {{--<div class="container-fluid">--}}
                {{--<div class="row">--}}
                    {{--<div class="col-md-12">--}}
                        {{--<h3>{{ renderText($category->texts, 'contactTechnical', 'title') }}</h3>--}}
                        {{--<br />--}}
                    {{--</div>--}}
                    {{--<div class="col-md-12">--}}
            ...
            {{--</div>--}}
        {{--</div>--}}
        {{--<div id="sale-7" role="tabpanel" class="tab-pane tab-subpane">--}}
            {{--<div class="container-fluid">--}}
                {{--<div class="row">--}}
                    {{--<div class="col-md-12">--}}
                        {{--<h3>{{ renderText($category->texts, 'contactFinancial', 'title') }}</h3>--}}
                        {{--<br />--}}
                    {{--</div>--}}
                    {{--<div class="col-md-12">--}}
            ...
            {{--</div>--}}
        {{--</div>--}}
        {{--<div id="sale-8" role="tabpanel" class="tab-pane tab-subpane">--}}
            {{--<div class="container-fluid">--}}
                {{--<div class="row">--}}
                    {{--<div class="col-md-12">--}}
                        {{--<h3>{{ renderText($category->texts, 'contactAudit', 'title') }}</h3>--}}
                        {{--<br />--}}
                    {{--</div>--}}
                    {{--<div class="col-md-12">--}}
            ...
            {{--</div>--}}
        {{--</div>--}}
        {{--<div id="sale-9" role="tabpanel" class="tab-pane tab-subpane">--}}
            {{--<div class="container-fluid">--}}
                {{--<div class="row">--}}
                    {{--<div class="col-md-12">--}}
                        {{--<h3> {{ renderText($category->texts, 'contactDirector', 'title') }}</h3>--}}
                        {{--<br />--}}
                    {{--</div>--}}
                    {{--<div class="col-md-12">--}}
            ...
            {{--</div>--}}
        {{--</div>--}}
        {{--<div id="sale-10" role="tabpanel" class="tab-pane tab-subpane">--}}
            {{--<div class="container-fluid">--}}
                {{--<div class="row">--}}
                    {{--<div class="col-md-12">--}}
                        {{--<h3> {{ renderText($category->texts, 'contactBoard', 'title') }}</h3>--}}
                        {{--<br />--}}
                    {{--</div>--}}
                    {{--<div class="col-md-12">--}}
