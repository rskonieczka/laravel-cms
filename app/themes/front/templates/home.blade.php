...
<section class="container section-top" style="padding-top:0;">
    <div class="row">
        <div class="col-md-12">
...
position: relative;"></i></span>
                        ...
                        <div class="table-cell text-center animated" data-fx="bounceIn" data-time="50">
                            ...
                            <div class="desc"><br><br><br>Comparative analysis<br> of the regulations in force <br>in the states participating <br>in the Project.
...
today = new Date();
    ...
    BigDay = new Date('2015/05/27');
    msPerDay = 24 * 60 * 60 * 1000 ;
    timeLeft = (BigDay.getTime() - today.getTime());
    e_daysLeft = timeLeft / msPerDay;
    daysLeft = Math.ceil(e_daysLeft);
    e_hrsLeft = (e_daysLeft - daysLeft)*24;
    hrsLeft = Math.ceil(e_hrsLeft);
    minsLeft = Math.ceil((e_hrsLeft - hrsLeft)*60);
    leftDeys = daysLeft + "<br /><small style='font-size:18px;'>days left</small> ";
    $('#countdown').html('<p style="font-size:52px;"><strong>'+leftDeys+'</strong></p>');
</script>
@stop